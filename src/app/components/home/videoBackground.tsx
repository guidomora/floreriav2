    ...
    return (
        ...
        <div className="w-[100%] h-[100vh] overflow-hidden">
            <div className="absolute top-[30vh] flex justify-center items-center w-[100%] z-10">
                <h1 className={`border-4 border-violet-400 p-12 font-thin font-goodSans 
                text-3xl   md:text-6xl xl:text-9xl text-shadow-outline ${styles['texto-borde']}`}>Florería Morabito</h1>
            </div>
