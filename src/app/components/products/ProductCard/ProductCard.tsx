  ...
  return (
    <div className=" bg-white  rounded-3xl shadow-2xl flex flex-col justify-between m-2 w-[75%] sm:w-[35%] md:w-[35%]  lg:w-[25%] xl:w-[20%] 2xl:w-[18%]">
      <Image
        ...
        src={'https://firebasestorage.googleapis.com/v0/b/floreria-morabito.appspot.com/o/ramo24.jpeg?alt=media&token=e9aff44d-779e-4943-bec6-bb7cd567346d'}
        width={500}
        height={500}
        alt="ramo" />
      <div className="h-[100%] p-2 flex-col justify-between">
        <div className="flex justify-center items-baseline gap-4 mb-3">
          <h4 className="text-sm text-violet-400">Ramo de flores</h4>
          <span className="text-sm font-thin">
            <strong className=" text-violet-700">$40.000</strong>
          </span>
        </div>
